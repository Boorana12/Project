                                ...
                                <table cellpadding="10">
                                    <thead>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <?php echo "<img src='../img/researchimg/" . $row['research_Image'] . "'width='250' height='180' align='center'>" . "<br>" ?>
                                                <div>
                                                    <h4>
                                                        <font size="4">ชื่อผลงานภาษาไทย :
                                                            <?php echo $row['research_NameThai'] ?>
                                                </div>
                                                <div>
                                                    <font size="4">ชื่อผลงานภาษาอังกฤษ :
                                                        <?php echo  $row['research_NameEnglish'] ?>
                                                </div>
                                            </td>
                                            <td>
                                                <div>
                                                    <font size="4">หัวหน้าคณะผู้จัดทำ : </font>
                                                    <?php echo "<font size='4'>" . $row['research_ProjectLeaderName'] . "</font >" ?>
                                                </div>
                                                <div>
                                                    <font size="4">ประเภท : </font>
                                                    <?php echo  "<font size='4'>" . $row['research_Type'] . "</font >" ?>
                                                </div>
                                                <div>
                                                    <font size="4">อีเมลล์ของหัวหน้าคณะผู้จัดทำ : </font>
                                                    <?php echo "<font size='4'>" . $row['research_ProjectLeaderEmail'] . "</font >" ?>
                                                </div>
                                                <div>
                                                    <font size="4">อาจารย์ที่ปรึกษาหลัก : </font>
                                                    <?php echo "<font size='4'>" . $row['research_AdvisorName'] . "</font >" ?>
                                                </div>
                                                <div>
                                                    <font size="4">จัดทำเมื่อปีการศึกษา : </font>
                                                    <?php echo "<font size='4'>" . $row['research_YearCompletion'] . "</font >" ?>
                                                </div>
                                                <div>
                                                    <font size="4">ระดับชั้น : </font>
                                                    <?php echo "<font size='4'>" . $row['research_StudentClass'] . "</font >" ?>
                                                </div>
                                                <div>
                                                    <font size="4">จำนวนสมาชิก : </font>
                                                    <?php echo "<font size='4'>" . $row['research_Member'] . "</font >" ?>
                                                </div>
                                            </td>
                                        </tr>
                                        <thead>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <p class="abstract" style="word-break:break-all">
                                                        <font size="4">บทคัดย่อ</font>
                                                        <br><?php echo "<font size='4'>" . $row['research_Text'] . "</font >" ?>
                                                    </p>
                                                </td>
                                            </tr>
