                ...
                <div class="col-6">
                    ...
                    <form method="POST" action="Process/UpdateResearch.php" enctype="multipart/form-data"
                        ...
                        <div class="form-group">
                            ...
                            <input id="research-no" name="research-no" placeholder="" type="text" class="form-control"
                                required="required" value="<?php echo $row["research_No"] ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <input id="research-name-thai" name="research-name-thai" placeholder="" type="text"
                                ...
                                value="<?php echo $row["research_NameThai"] ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <input id="research-name-english" name="research-name-english" placeholder="" type="text"
                                class="form-control" required="required"
                                value="<?php echo $row["research_NameEnglish"] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input id="research-name-projectleader" name="research-name-projectleader" placeholder=""
                                ...
                                value="<?php echo $row["research_ProjectLeaderName"] ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <input id="research-email-projectleader" name="research-email-projectleader" placeholder=""
                                ...
                                value="<?php echo $row["research_ProjectLeaderEmail"] ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <input id="research-name-advisor" name="research-name-advisor" placeholder="" type="text"
                                class="form-control" required="required"
                                value="<?php echo $row["research_AdvisorName"] ?>">
                        </div>
                        <div class="form-group">
                            ...
                            <input id="research-yearcompletion" name="research-yearcompletion" placeholder=""
                                ...
                                value="<?php echo $row["research_YearCompletion"] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="form-control" name="research-text" rows="10"
                                cols="75"><?php echo $row["research_Text"] ?></textarea>
                        </div>
                        <div class="form-group">
