                        ...
                        <table id="example" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                <div>
                                    ...
                                    //$readResearch = "SELECT * FROM researchs , users WHERE researchs.research_ProjectLeaderEmail;";
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($readResearchResult)) { ?>
                                            <tr>
                                                <td style="text-align:justify;text-justify:inter-word">
                                                    <?php echo $row["research_No"] ?></td>
                                                <td style="text-align:justify;text-justify:inter-word">
                                                    <?php echo $row["research_NameThai"] ?></td>
                                                <td style="text-align:justify;text-justify:inter-word">
                                                ...
                                                <?php
                                                echo "<td><a class=\"btn btn-primary btn-block\" href=\"./UserUpdatePage.php?id=" . $row["research_No"] . "\" role=\"button\">แก้ไข</a></td>";
                                                echo "<td><div class=\"btn btn-danger btn-block\"><a class=\"btn-del\" href=\"./Process/UserDelete.php?id=" . $row["research_No"] . "\" role=\"button\">ลบ</a></div></td>";
                                                ?>
                                            </tr>
                                        <?php } ?>
                                    <?php } else { ?>
